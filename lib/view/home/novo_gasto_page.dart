...
class NovoGastoPage extends StatefulWidget {
  NovoGastoPage({this.month});

  final Month month;

  @override
  State<StatefulWidget> createState() => _NovoGastoPageState();
}

class _NovoGastoPageState extends State<NovoGastoPage> implements MonthContractView {
